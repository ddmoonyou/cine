...
REPLACE INTO `branchinfo` (`branch_id`, `branch_address`, `branch_telephone`, `branch_name`) VALUES
...
-- Dumping data for table cine.foodinfo: ~10 rows (approximately)
REPLACE INTO `foodinfo` (`food_type`, `category`, `description`) VALUES
...
-- Dumping data for table cine.foodsize: ~28 rows (approximately)
REPLACE INTO `foodsize` (`food_id`, `food_type`, `size`, `price`) VALUES
	(101, 'Pepsi', 'S', 90),
	(102, 'Pepsi', 'M', 140),
	(103, 'Pepsi', 'L', 190),
	(104, 'Pepsi Max', 'S', 90),
...
REPLACE INTO `layouttype` (`layout_type`) VALUES
	('A'),
	('B'),
	('C');

-- Dumping data for table cine.movieinfo: ~12 rows (approximately)
REPLACE INTO `movieinfo` (`movie_id`, `movie_name`, `movie_description`, `movie_trailer`, `director_info`, `movie_poster`, `movie_length`, `releaseDate`, `promote`) VALUES
	...
	(100000004, 'The Super Mario Bros. Movie', 'The story of The Super Mario Bros. on their journey through the Mushroom Kingdom.', 'https://www.youtube.com/watch?v=rG4tpqT5zlw', 'Aaron Horvath, Michael Jelenic, Pierre Leduc', 'https://www.imdb.com/title/tt6718170/mediaviewer/rm1378366465/?ref_=tt_ov_i', 92, '2023-04-05', NULL),
	(100000005, 'Creed III', 'Adonis has been thriving in both his career and family life, but when a childhood friend and former boxing prodigy resurfaces, the face-off is more than just a fight.', 'https://www.youtube.com/watch?v=AHmCH7iB_IM', 'Michael B. Jordan', 'https://www.imdb.com/title/tt11145118/mediaviewer/rm669921281/?ref_=tt_ov_i', 116, '2023-03-02', NULL),
	(100000006, 'Dungeons & Dragons: Honor Among Thieves', 'A charming thief and a band of unlikely adventurers embark on an epic quest to retrieve a lost relic, but things go dangerously awry when they run afoul of the wrong people.', 'https://www.youtube.com/watch?v=IiMinixSXII', 'John Francis Daley, Jonathan Goldstein', 'https://www.imdb.com/title/tt2906216/mediaviewer/rm2360753153/?ref_=tt_ov_i', 134, '2023-03-03', NULL),
	(100000007, 'Barbie', 'To live in Barbie Land is to be a perfect being in a perfect place. Unless you have a full-on existential crisis. Or you\'re a Ken.', 'https://www.youtube.com/watch?v=8zIf0XvoL9Y', 'Greta Gerwig', 'https://www.imdb.com/title/tt1517268/mediaviewer/rm2419599361/?ref_=tt_ov_i', NULL, '2023-07-21', NULL),
	(100000008, 'Operation Fortune: Ruse de guerre', 'Special agent Orson Fortune and his team of operatives recruit one of Hollywood\'s biggest movie stars to help them on an undercover mission when the sale of a deadly new weapons technology threatens to disrupt the world order.', 'https://www.youtube.com/watch?v=W8Sqk1GcqxY', 'Guy Ritchie', 'https://www.imdb.com/title/tt7985704/mediaviewer/rm576532737/?ref_=tt_ov_i', 114, '2023-04-20', NULL),
	(100000009, 'Spider-Man: Across the Spider-Verse', 'Miles Morales catapults across the Multiverse, where he encounters a team of Spider-People charged with protecting its very existence. When the heroes clash on how to handle a new threat, Miles must redefine what it means to be a hero.', 'https://www.youtube.com/watch?v=cqGjhVJWtEg', 'Joaquim Dos, SantosKemp Powers, Justin K. Thompson', 'https://www.imdb.com/title/tt9362722/mediaviewer/rm2758622721/?ref_=tt_ov_i', 120, '2023-06-02', NULL),
...
REPLACE INTO `seatlayout` (`seat_id`, `seat_type`, `layout_type`, `seat_row`, `seat_column`) VALUES
...
REPLACE INTO `seatprice` (`seat_type`, `price`) VALUES
	('Honeymoon Seat', 400),
	('Premium Bed', 2500),
	('Premium Seat', 180);

-- Dumping data for table cine.showings: ~15 rows (approximately)
REPLACE INTO `showings` (`showing_id`, `branch_id`, `theater_no`, `movie_id`, `date_time`, `language_dub`, `language_sub`) VALUES
	...
	(481000016, 1001, 1, 100000001, '2023-04-29 22:54:00', 'EN', 'TH'),
	(481000017, 1001, 1, 100000001, '2023-05-15 03:00:00', 'EN', 'TH'),
	(481000018, 1001, 1, 100000001, '2023-05-18 22:36:26', 'EN', 'TH');

-- Dumping data for table cine.staffinfo: ~0 rows (approximately)
REPLACE INTO `staffinfo` (`staff_id`, `branch_id`, `staff_role`, `staff_first_name`, `staff_last_name`, `staff_tel`) VALUES
	(840200001, 1001, 'Manager', 'Neramit', 'Matarat', '0992866777');

-- Dumping data for table cine.systemtype: ~4 rows (approximately)
REPLACE INTO `systemtype` (`system_type`) VALUES
	('4D'),
	('Bed Cinema'),
	('IMAX'),
	('Laser');
...
REPLACE INTO `theaterinfo` (`branch_id`, `theater_no`, `layout_type`, `system_type`) VALUES
	(1001, 1, 'A', 'Bed Cinema'),
	(1001, 2, 'B', 'Bed Cinema'),
	(1001, 3, 'C', 'Bed Cinema'),
	(1001, 4, 'A', '4D'),
